...
export default function BottomNav({ onBackup }) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-800 bg-slate-900/95 backdrop-blur-sm"
      ...
      <div className="flex">
        ...
        <button
          onClick={onBackup}
          className="flex flex-col items-center justify-center flex-1 py-2 gap-0.5 text-xs font-medium text-slate-500 hover:text-slate-300 transition-colors"
        >
