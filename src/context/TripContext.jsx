...
const SEED_ITINERARY = [
  { id: 'day-01', date: '2026-07-04', city: 'Frankfurt', notes: 'Depart 12:00 PM SIN. Arrive Frankfurt evening.', activities: [] },
  ...
  { id: 'day-16', date: '2026-07-19', city: 'Frankfurt', notes: 'Travel Würzburg → Frankfurt (~1.5h). Depart 12:00 PM FRA.', activities: [] },
]

const SEED_EVENTS = [
  { id: 'evt-01', title: 'Flight SIN → FRA', type: 'flight', date: '2026-07-04', time: '12:00', location: 'Changi Airport T3', bookingRef: '', url: '', notes: '', status: 'booked' },
  ...
  { id: 'evt-03', title: 'Flight FRA → SIN', type: 'flight', date: '2026-07-19', time: '12:00', location: 'Frankfurt Airport', bookingRef: '', url: '', notes: '', status: 'booked' },
