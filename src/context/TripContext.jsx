...
const SEED_ITINERARY = [
  ...
  { id: 'day-02', date: '2026-07-05', city: 'Cologne', notes: 'Morning in Cologne with brother. After lunch travel to Brussels, Belgium.', sleep: 'Brussels, Belgium', travel: [
  ...
  { id: 'day-04', date: '2026-07-07', city: 'Maastricht → Plauen', notes: 'Morning: travel Maastricht → Cologne. Train Cologne → Nuremberg 12:45–15:58 (ticket bought). Then train Nuremberg → Plauen. (Düsseldorf visit skipped.)', sleep: 'Plauen, Germany', travel: [
    { mode: 'train', duration: '~1h', notes: 'Maastricht → Cologne Hbf (morning)' },
    { mode: 'train', duration: '3h 13m', notes: 'Cologne Hbf → Nuremberg Hbf · 12:45–15:58 (ticket bought)' },
    { mode: 'train', duration: '~1h 30m', notes: 'Nuremberg → Plauen — check DB timetable' },
  ], activities: []},

  { id: 'day-05', date: '2026-07-08', city: 'Plauen', notes: 'Travel around Plauen whole day. Visit uncle at Pestalozzistraße 50, 08523 Plauen.', sleep: 'Plauen, Germany', travel: [], activities: [
    { id: 'plau-1', time: '', title: 'Plauen — Visit Uncle at Pestalozzistraße 50', notes: 'Main purpose of Plauen stop. Full day to visit and explore together.', tags: ['local'], priority: 5, priorityNote: 'Main reason for the Plauen stop — family priority' },
  ...
  { id: 'day-06', date: '2026-07-09', city: 'Nice', notes: 'Train Plauen → Prague (morning), then fly Smartwings QS1030 PRG→NCE (19:30–21:20). Arrive Nice late evening.', sleep: 'Nice, France', travel: [
    { mode: 'train', duration: '~3h', notes: 'Plauen → Dresden Hbf → Prague hlavní nádraží — depart morning, arrive Prague early afternoon' },
    { mode: 'flight', duration: '1h 50m', notes: 'Smartwings QS1030 · PRG T2 19:30 → NCE T2 21:20 · 0PC baggage (prepaid confirmed)' },
  ], activities: [
    { id: 'nic-1', time: '', title: 'Visit Friend in Nice', notes: 'Main purpose of Nice stop — meet up and explore together.', tags: ['local'], priority: 5, priorityNote: 'Main reason for the Nice stop — friend priority' },
    { id: 'nic-2', time: '', title: 'Promenade des Anglais', notes: 'The iconic seafront promenade stretching 7km along the Mediterranean — best at sunset.', tags: ['scenic', 'outdoor', 'romantic'], priority: 4, priorityNote: 'Iconic Nice seafront — easy walk with friend in the evening' },
    { id: 'nic-3', time: '', title: 'Vieux-Nice (Old Town)', notes: 'Pastel-coloured buildings, Cours Saleya market, excellent socca (chickpea pancake). Very safe and vibrant in the evening.', tags: ['food', 'local', 'historical'], priority: 4, priorityNote: 'Best neighbourhood in Nice — good food and local atmosphere' },
  ]},

  { id: 'day-07', date: '2026-07-10', city: 'Nice', notes: 'Day 2 in Nice with friend. Depart to Tuscany on Saturday 11 Jul.', sleep: 'Nice, France', travel: [], activities: [
    { id: 'nic-4', time: '', title: 'Nice Beach & French Riviera Morning', notes: 'Nice has public pebble beaches along the Promenade — free entry, crystal-clear water.', tags: ['nature', 'outdoor', 'relaxation', 'wellness'], priority: 4, priorityNote: 'Mediterranean swim — rare opportunity on this trip' },
    { id: 'nic-5', time: '', title: 'Castle Hill (Colline du Château)', notes: 'Free panoramic viewpoint over Nice and the Baie des Anges — 15-min walk or lift.', tags: ['scenic', 'outdoor', 'photography'], priority: 4, priorityNote: 'Best free view in Nice — 30-min stop, great photos' },
    { id: 'nic-6', time: '', title: 'Cours Saleya Flower & Food Market', notes: 'Open-air market in Old Nice — fresh produce, flowers, local cheeses and cured meats. Morning only.', tags: ['food', 'local', 'shopping'], priority: 3, priorityNote: 'Lovely morning market — go early before it closes around noon' },
  ]},

  // — Italy leg —
  { id: 'day-08', date: '2026-07-11', city: 'Tuscany', notes: 'Travel Nice → Tuscany (Italy). Saturday. Arrive afternoon.', sleep: 'Florence / Tuscany, Italy', travel: [
    { mode: 'train', duration: '~5–6h', notes: 'Nice → Genova → La Spezia → Florence SMN (Trenitalia) — check timetable. Or Nice → Pisa → Florence.' },
    { mode: 'car', duration: '~4h', notes: 'via A8/A10/A7/A1 — more flexible for countryside arrival' },
  ], activities: [
  ...
  { id: 'day-09', date: '2026-07-12', city: 'Tuscany', notes: 'Tuscany full day. Depart to Rome on Monday 13 Jul.', sleep: 'Florence / Tuscany, Italy', travel: [], activities: [
  ...
  { id: 'day-10', date: '2026-07-13', city: 'Rome', notes: 'Travel Tuscany → Rome. Arrive afternoon. 2 nights in Rome.', sleep: 'Rome, Italy', travel: [
    { mode: 'train', duration: '1h 30m', notes: 'Trenitalia Frecciarossa Florence SMN → Roma Termini — fastest' },
    { mode: 'car', duration: '3h', notes: 'via A1 — more flexible' },
  ], activities: [
  ...
  { id: 'day-11', date: '2026-07-14', city: 'Rome', notes: 'Rome Day 2 — Ancient Rome + Vatican.', sleep: 'Rome, Italy', travel: [], activities: [
    ...
    { id: 'rom-2-3', time: '', title: 'Vatican Museums + Sistine Chapel', notes: 'Michelangelo\'s ceiling — book well in advance, allow 3–4h minimum', tags: ['historical', 'culture'], priority: 5, priorityNote: 'Sistine Chapel is a once-in-a-lifetime sight — book weeks ahead' },
    { id: 'rom-2-4', time: '', title: 'St. Peter\'s Basilica + Dome', notes: 'Free entry to basilica — climb the dome for sweeping Rome views', tags: ['historical', 'culture', 'scenic', 'outdoor'], priority: 5, priorityNote: 'Free entry, iconic dome — book dome climb separately, unmissable' },
    { id: 'rom-2-5', time: '', title: 'Aperitivo at Sunset — Trastevere', notes: 'Trastevere is Rome\'s safest and most atmospheric evening neighbourhood — cobbled lanes, lit by warm lamps, busy with families and tourists until midnight.', tags: ['food', 'local', 'nightlife', 'romantic'], priority: 5, priorityNote: 'Best neighbourhood in Rome for an evening — very safe, very romantic' },
    { id: 'rom-2-6', time: '', title: 'Michelin Star Dinner', notes: 'Book a restaurant in advance — Rome has several starred options at various price points', tags: ['food', 'romantic'], priority: 4, priorityNote: 'Special Rome memory — book in advance, worth the splurge' },
  ]},
  ...
  // — Return Germany leg —
  { id: 'day-14', date: '2026-07-17', city: 'Würzburg', notes: 'Morning & afternoon free in Venice. Fly Venice → Frankfurt: Condor DE4234, depart 16:45, arrive 18:05. Train Frankfurt Airport → Würzburg (booked). Check-in hotel.', sleep: 'Würzburg, Germany', travel: [
    { mode: 'flight', duration: '1h 20m', notes: 'Condor DE4234 · VCE 16:45 → FRA 18:05 · Booking 16665224 · Contact Thanh +6584338479' },
    { mode: 'train', duration: '~1h', notes: 'Frankfurt Airport → Würzburg Hbf — booked' },
  ], activities: [] },
...
const SEED_EVENTS = [
  ...
  { id: 'evt-07', title: 'Train Cologne → Nuremberg', type: 'transport', date: '2026-07-07', time: '12:45', location: 'Cologne Hbf', bookingRef: '', url: '', notes: 'Cologne Hbf 12:45 → Nuremberg Hbf 15:58 · Ticket bought. Then onward train Nuremberg → Plauen.', status: 'booked' },
  { id: 'evt-02', title: 'Flight PRG → NCE (Smartwings QS1030)', type: 'flight', date: '2026-07-09', time: '19:30', location: 'Prague Václav Havel Airport T2 (PRG)', bookingRef: 'QS1030', url: '', notes: 'Smartwings QS1030 · Depart PRG T2 19:30 → Arrive NCE T2 21:20 · Duration 1h 50m · Class LITE J · 0PC baggage (prepaid baggage confirmed - PDBG)', status: 'booked' },
  ...
  { id: 'evt-06', title: 'Flight VCE → FRA (Condor DE4234)', type: 'flight', date: '2026-07-17', time: '16:45', location: 'Venice Marco Polo Airport (VCE)', bookingRef: '16665224', url: '', notes: 'Condor DE4234 · Depart VCE 16:45 → Arrive FRA 18:05 · 1h 20min · No time difference · Booking: 16665224 · Contact: Thanh nguyenvanthanh2210@gmail.com, +6584338479', status: 'booked' },
  ...
  // — Hotel placeholders —
  { id: 'evt-08', title: 'Hotel — Brussels (B&B HOTEL Brussels Centre Louise)', type: 'hotel', date: '2026-07-05', time: '15:00', location: 'Rue Paul Spaak 15, Brussels, Belgium 1000', bookingRef: '6316624979', url: '', notes: 'Check-in: 5 Jul (Sun) · Check-out: 6 Jul (Mon) · 1 night · €156.91 paid on 2 Jul 2026 · Booked by Xuan Nguyen', status: 'booked' },
  ...
  { id: 'evt-09', title: 'Stay with Uncle — Plauen', type: 'other', date: '2026-07-08', time: '', location: 'Pestalozzistraße 50, 08523 Plauen', bookingRef: '', url: '', notes: 'Staying with uncle. No hotel needed.', status: 'confirmed' },
  { id: 'evt-10', title: 'Hotel — Nice', type: 'hotel', date: '2026-07-09', time: '14:00', location: 'Nice, France', bookingRef: '', url: '', notes: 'Check-in: 9 Jul · Check-out: 11 Jul · 2 nights. Visiting friend in Nice.', status: 'pending' },
  { id: 'evt-11', title: 'Hotel — Florence / Tuscany', type: 'hotel', date: '2026-07-11', time: '14:00', location: 'Florence or Tuscany countryside, Italy', bookingRef: '', url: '', notes: 'Check-in: 11 Jul (Sat) · Check-out: 13 Jul (Mon) · 2 nights. City hotel in Florence vs agriturismo in countryside — both within budget range.', status: 'pending' },
  { id: 'evt-12', title: 'Hotel — Rome', type: 'hotel', date: '2026-07-13', time: '14:00', location: 'Rome, Italy', bookingRef: '', url: '', notes: 'Check-in: 13 Jul (Mon) · Check-out: 15 Jul (Wed) · 2 nights', status: 'pending' },
  ...
  { id: 'evt-14', title: 'Hotel — Würzburg (homie hotel zur stadt mainz)', type: 'hotel', date: '2026-07-17', time: '14:00', location: 'Semmelstr. 39, 97070 Würzburg', bookingRef: '6637574880', url: '', notes: 'homie hotel zur stadt mainz · Semmelstr. 39, 97070 Würzburg · Check-in: 17 Jul · Check-out: 19 Jul · 2 nights · €267.61 paid on 25 Jun 2026 · Booked by Xuan Nguyen', status: 'booked' },
]

const SEED_TASKS = [
  // — Flights —
  { id: 'task-01', category: 'Flights', title: 'Book PRG → NCE flight (9 Jul, 19:30)', assignee: 'Xuan', done: true, priority: 'critical', notes: 'Smartwings QS1030 · PRG T2 19:30 → NCE T2 21:20 · Booked ✓ · Prepaid baggage confirmed (PDBG)' },
  { id: 'task-02', category: 'Flights', title: 'Book VCE → FRA flight (17 Jul)', assignee: 'Thanh', done: true, priority: 'critical', notes: 'Condor DE4234 · VCE 16:45 → FRA 18:05 · Booking 16665224 · €paid' },
  ...
  // — Car & Insurance —
  { id: 'task-04', category: 'Transport', title: 'Book train Frankfurt Airport → Würzburg (17 Jul)', assignee: 'Unassigned', done: true, priority: 'high', notes: 'Booked. After landing FRA 18:05 from Condor DE4234.' },
  ...
  // — Hotels —
  { id: 'task-07', category: 'Hotels', title: 'Book hotel — Brussels (1 night, 5–6 Jul)', assignee: 'Xuan', done: true, priority: 'high', notes: 'B&B HOTEL Brussels Centre Louise · Rue Paul Spaak 15 · Booking 6316624979 · €156.91 paid on 2 Jul 2026' },
  ...
  { id: 'task-09', category: 'Hotels', title: 'Book hotel — Nice (2 nights, 9–11 Jul)', assignee: 'Unassigned', done: false, priority: 'high', notes: 'Visiting friend — check if staying with friend or need hotel. Central Nice near Promenade des Anglais.' },
  { id: 'task-10', category: 'Hotels', title: 'Book hotel — Tuscany (2 nights, 11–13 Jul)', assignee: 'Unassigned', done: false, priority: 'high', notes: 'Florence city hotel OR agriturismo in countryside. Check-in Sat 11 Jul, check-out Mon 13 Jul.' },
  { id: 'task-11', category: 'Hotels', title: 'Book hotel — Rome (2 nights, 13–15 Jul)', assignee: 'Unassigned', done: false, priority: 'critical', notes: 'Near Trastevere or Campo de\' Fiori. Check-in Mon 13 Jul, check-out Wed 15 Jul. Book now — July fills fast.' },
  ...
  { id: 'task-13', category: 'Hotels', title: 'Book hotel — Würzburg (2 nights, 17–19 Jul)', assignee: 'Xuan', done: true, priority: 'high', notes: 'homie hotel zur stadt mainz · Semmelstr. 39 · Booking 6637574880 · €267.61 paid' },
  // — Confirmations —
  { id: 'task-14', category: 'Confirmations', title: 'Confirm uncle visit — Plauen (8 Jul)', assignee: 'Unassigned', done: true, priority: 'critical', notes: 'Pestalozzistraße 50. Staying overnight with uncle — no hotel needed.' },
  // — Tickets —
  { id: 'task-15', category: 'Tickets', title: 'Book Vatican Museums + Sistine Chapel (14 Jul)', assignee: 'Unassigned', done: false, priority: 'high', notes: 'museivaticani.va · Sells out weeks ahead in July. Allow 3–4h.' },
  { id: 'task-16', category: 'Tickets', title: 'Book Colosseum + Forum + Palatine Hill (14 Jul)', assignee: 'Unassigned', done: false, priority: 'high', notes: 'coopculture.it · Combined timed-entry ticket.' },
  { id: 'task-17', category: 'Tickets', title: 'Book Uffizi Gallery (12 Jul)', assignee: 'Unassigned', done: false, priority: 'high', notes: 'uffizi.it · 2–3h queue if walk-up in July.' },
]
